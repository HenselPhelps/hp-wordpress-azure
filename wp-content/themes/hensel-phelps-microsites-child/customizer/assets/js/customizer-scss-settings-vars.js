(function (root, CP_Customizer, $) {
    ...
    CP_Customizer.addModule(function (CP_Customizer) {
        ...
        var settings = [
            ...
            "ope_woo_upsells_list_item_desktop_cols",
            "ope_woo_upsells_list_item_tablet_cols",
            
            "ope_woo_cross_sell_list_item_desktop_cols",
            "ope_woo_cross_sell_list_item_tablet_cols",

            "ope_woo_related_list_item_desktop_cols",
            "ope_woo_related_list_item_tablet_cols",
            
            "ope_woo_primary_color",
            "ope_woo_secondary_color",
            "ope_woo_onsale_color"
        ];
        ...
        var repeaterControlVars = function (settingID, value) {
            var result = {};
            switch (settingID) {
                case 'one_page_express_color_pallete':
