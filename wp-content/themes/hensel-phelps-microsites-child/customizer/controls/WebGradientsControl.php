...
class WebGradientsControl extends \Kirki_Customize_Control
{
    ...
    {
        $this->button_label = __('Change Gradient', 'one-page-express');
    ...
    public function enqueue()
    {
        ...
        wp_enqueue_script('webgradients-media-tab', $jsRoot . "/webgradients-media-tab.js",array('media-views'));
        wp_enqueue_script('webgradients-control', $jsRoot . "/webgradients-control.js", array("webgradients-media-tab"));
    }
